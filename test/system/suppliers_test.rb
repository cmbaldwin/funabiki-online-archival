...
class SuppliersTest < ApplicationSystemTestCase
  ...
  #   fill_in "Company name", with: @supplier.company_name
  #   fill_in "Representative name", with: @supplier.representative_name
  #   fill_in "Supplier number", with: @supplier.supplier_number
